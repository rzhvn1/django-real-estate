...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+123456789")
    ...
    country = CountryField(verbose_name=_("Country"), default="KG", blank=False, null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Bishkek", blank=False, null=False)
